...
A Claude Code and Codex recipe that syncs new RSS articles into your Pachinko inbox as markdown notes from an OPML file.  It requires the following values to be provided.
