# Sync Youtube Channel Recipe

A Claude Code recipe that fetches new videos from a Youtube channel, filters them against optional instructions, and adds matching videos to your Pachinko inbox as markdown notes.
...
| Skill   | Description                                                         |
| ------- | ------------------------------------------------------------------- |
| `run` | Full pipeline: fetch new videos → filter → add to Pachinko inbox |
